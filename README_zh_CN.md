...
2. 双击文档列表的文档 或 单击文档开头的图标，如果该文档存在子文档，会切换路径查看子文档列表。
3. 二级文档列表选中的文档可以拖拽到文档树进行移动，支持 `按紧Ctrl + 单击` 和 `按紧Shift + 方向键` 多选文档。
4. 文档树的文档支持拖拽到二级文档列表，如果二级文档列表选择了路径，可以拖到顶部区域到当前路径。拖动到对应文档上会变成子文档。
5. 可以在文档树的更多菜单，切换二级文档列表的显示。
6. 路径可以点击进行切换。
...
#### 二级文档列表中的快捷键
当焦点处于二级文档列表中的时候，可以通过快捷键触发顶部按钮，快捷键如下：
* 定位当前打开的文档 — ALT + D
* 锁定(解锁)路径 — ALT + Q
* 锁定(解锁)排序方式 — ALT + W
* 显示(隐藏)子文件夹 — ALT + E
